...
{
	public partial class QRRepository : QRRepositoryBase, IQRRepository
	{
		private QRDataContext _ctx;

		public QRRepository(QRDataContext ctx) : base(ctx)
		{
			_ctx = ctx;
		...
		public QRDataContext QRDataContext { get { return _ctx; } }
