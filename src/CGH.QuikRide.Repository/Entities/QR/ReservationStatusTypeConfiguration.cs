...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    public partial class ReservationStatusTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ReservationStatusType>
    {
        public ReservationStatusTypeConfiguration()
            : this("dbo")
        {
        }

        public ReservationStatusTypeConfiguration(string schema)
        {
            ToTable("ReservationStatusType", schema);
            HasKey(x => x.ReservationStatusTypeId);

            Property(x => x.ReservationStatusTypeId).HasColumnName(@"ReservationStatusTypeId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            ...
            // Foreign keys
            HasRequired(a => a.LanguageType).WithMany(b => b.ReservationStatusTypes).HasForeignKey(c => c.LanguageTypeId).WillCascadeOnDelete(false); // FK_ReservationStatusType_LanguageType
            InitializePartial();
        }
