...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    public partial class UserRewardAccountConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UserRewardAccount>
    {
        public UserRewardAccountConfiguration()
            : this("dbo")
        {
        }

        public UserRewardAccountConfiguration(string schema)
        {
            ToTable("UserRewardAccount", schema);
            HasKey(x => x.UserId);
