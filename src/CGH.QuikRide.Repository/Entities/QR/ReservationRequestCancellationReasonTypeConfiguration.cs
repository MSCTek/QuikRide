...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    public partial class ReservationRequestCancellationReasonTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ReservationRequestCancellationReasonType>
    {
        public ReservationRequestCancellationReasonTypeConfiguration()
            : this("dbo")
        {
        }

        public ReservationRequestCancellationReasonTypeConfiguration(string schema)
        {
            ToTable("ReservationRequestCancellationReasonType", schema);
            HasKey(x => x.ReservationRequestCancellationReasonTypeId);

            Property(x => x.ReservationRequestCancellationReasonTypeId).HasColumnName(@"ReservationRequestCancellationReasonTypeId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            ...
            // Foreign keys
            HasRequired(a => a.LanguageType).WithMany(b => b.ReservationRequestCancellationReasonTypes).HasForeignKey(c => c.LanguageTypeId).WillCascadeOnDelete(false); // FK_ReservationRequestCancellationReasonType_LanguageType
            InitializePartial();
        }
