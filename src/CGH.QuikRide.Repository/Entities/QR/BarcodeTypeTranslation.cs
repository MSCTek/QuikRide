...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    {
        public int BarcodeTypeTranslationId { get; set; } // BarcodeTypeTranslationId (Primary key)
        ...
        /// <summary>
        /// Parent BarcodeType pointed by [BarcodeTypeTranslation].([BarcodeTypeId]) (FK_BarcodeTypeTranslation_BarcodeType)
        /// </summary>
        public BarcodeType BarcodeType { get; set; } // FK_BarcodeTypeTranslation_BarcodeType

        /// <summary>
        /// Parent LanguageType pointed by [BarcodeTypeTranslation].([LanguageTypeId]) (FK_BarcodeTypeTranslation_LanguageType)
        /// </summary>
        public LanguageType LanguageType { get; set; } // FK_BarcodeTypeTranslation_LanguageType
