...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    {
        public int LocationTypeTranslationId { get; set; } // LocationTypeTranslationId (Primary key)
        ...
        /// <summary>
        /// Parent LanguageType pointed by [LocationTypeTranslation].([LanguageTypeId]) (FK_LocationTypeTranslation_LanguageType)
        /// </summary>
        public LanguageType LanguageType { get; set; } // FK_LocationTypeTranslation_LanguageType

        /// <summary>
        /// Parent LocationType pointed by [LocationTypeTranslation].([LocationTypeId]) (FK_LocationTypeTranslation_LocationType)
        /// </summary>
        public LocationType LocationType { get; set; } // FK_LocationTypeTranslation_LocationType
