...
{
	public partial class ReservationRequestCancellationReasonTypeTranslation : ObservableObject
	{
		...
		private int _reservationRequestCancellationReasonTypeTranslationId;
		...
		public int ReservationRequestCancellationReasonTypeTranslationId
		{
			get { return _reservationRequestCancellationReasonTypeTranslationId; }
			set
			{
				Set<int>(() => ReservationRequestCancellationReasonTypeTranslationId, ref _reservationRequestCancellationReasonTypeTranslationId, value);
				RunCustomLogicSetReservationRequestCancellationReasonTypeTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetReservationRequestCancellationReasonTypeTranslationId(int value);
