...
{
	public partial class ReservationStatusTypeTranslation : ObservableObject
	{
		...
		private int _reservationStatusTypeTranslationId;
		...
		public int ReservationStatusTypeTranslationId
		{
			get { return _reservationStatusTypeTranslationId; }
			set
			{
				Set<int>(() => ReservationStatusTypeTranslationId, ref _reservationStatusTypeTranslationId, value);
				RunCustomLogicSetReservationStatusTypeTranslationId(value);
			}
		}
		...
		public virtual ReservationStatusType ReservationStatusType { get; set; } 
		...
		partial void RunCustomLogicSetReservationStatusTypeTranslationId(int value);
