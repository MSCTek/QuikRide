...
{
	public partial class VehicleFeatureTypeTranslation : ObservableObject
	{
		...
		private int _vehicleFeatureTypeTranslationId;
		...
		public int VehicleFeatureTypeTranslationId
		{
			get { return _vehicleFeatureTypeTranslationId; }
			set
			{
				Set<int>(() => VehicleFeatureTypeTranslationId, ref _vehicleFeatureTypeTranslationId, value);
				RunCustomLogicSetVehicleFeatureTypeTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetVehicleFeatureTypeTranslationId(int value);
