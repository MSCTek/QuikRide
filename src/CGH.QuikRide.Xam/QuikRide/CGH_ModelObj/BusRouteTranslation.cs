...
{
	public partial class BusRouteTranslation : ObservableObject
	{
		...
		private int _busRouteTranslationId;
		...
		public int BusRouteTranslationId
		{
			get { return _busRouteTranslationId; }
			set
			{
				Set<int>(() => BusRouteTranslationId, ref _busRouteTranslationId, value);
				RunCustomLogicSetBusRouteTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetBusRouteTranslationId(int value);
