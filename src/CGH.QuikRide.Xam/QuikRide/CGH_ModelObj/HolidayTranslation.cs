...
{
	public partial class HolidayTranslation : ObservableObject
	{
		...
		private int _holidayTranslationId;
		...
		public int HolidayId
		{
			...
			set
			{
				Set<int>(() => HolidayId, ref _holidayId, value);
				RunCustomLogicSetHolidayId(value);
			}
		}

		public int HolidayTranslationId
		{
			get { return _holidayTranslationId; }
			set
			{
				Set<int>(() => HolidayTranslationId, ref _holidayTranslationId, value);
				RunCustomLogicSetHolidayTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetHolidayTranslationId(int value);
