...
{
	public partial class BarcodeType : ObservableObject
	{
		public BarcodeType()
		{
			Barcodes = new System.Collections.Generic.List<Barcode>(); // Reverse Navigation
		...
		public virtual System.Collections.Generic.IList<Barcode> Barcodes { get; set; } // Many to many mapping
