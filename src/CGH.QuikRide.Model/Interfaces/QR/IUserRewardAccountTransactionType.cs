...
{
	public partial interface IUserRewardAccountTransactionType
	{
		string Code { get; }
		string CreatedBy { get; }
		System.DateTime CreatedUtcDate { get; }
		int DataVersion { get; }
		string DebitOrCredit { get; }
		bool IsDeleted { get; }
		string ModifiedBy { get; }
		System.DateTime ModifiedUtcDate { get; }
		int UserRewardAccountTransactionTypeId { get; }

		List<IUserRewardAccountTransaction> UserRewardAccountTransactions { get; }
