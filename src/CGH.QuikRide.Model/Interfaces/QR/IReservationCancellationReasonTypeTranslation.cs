...
{
	public partial interface IReservationCancellationReasonTypeTranslation
	{
		...
		int ReservationCancellationReasonTypeId { get; }
		int ReservationCancellationReasonTypeTranslationId { get; }
		string Value { get; }
