...
namespace CGH.QuikRide.DTO.QR
{
	public partial class ReservationCancellationReasonType
	{
		...
		public int ReservationCancellationReasonTypeId { get; set; } // Primary key
		...
		public virtual System.Collections.Generic.ICollection<ReservationCancellationReasonTypeTranslation> ReservationCancellationReasonTypeTranslations { get; set; } // Many to many mapping
