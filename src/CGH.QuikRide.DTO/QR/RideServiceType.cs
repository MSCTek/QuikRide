...
namespace CGH.QuikRide.DTO.QR
{
	public partial class RideServiceType
	{
		...
		public int RideServiceTypeId { get; set; } // Primary key
		...
		public virtual System.Collections.Generic.ICollection<RideServiceTypeTranslation> RideServiceTypeTranslations { get; set; } // Many to many mapping
