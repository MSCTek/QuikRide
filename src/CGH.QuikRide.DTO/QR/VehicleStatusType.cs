...
namespace CGH.QuikRide.DTO.QR
{
	public partial class VehicleStatusType
	{
		...
		public int VehicleStatusTypeId { get; set; } // Primary key
		...
		public virtual System.Collections.Generic.ICollection<VehicleStatusTypeTranslation> VehicleStatusTypeTranslations { get; set; } // Many to many mapping
