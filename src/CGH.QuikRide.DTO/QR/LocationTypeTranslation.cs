...
namespace CGH.QuikRide.DTO.QR
{
	public partial class LocationTypeTranslation
	{
		...
		public int LocationTypeTranslationId { get; set; } // Primary key
		...
		// public virtual LocationType LocationType { get; set; }  -- Excluded navigation property per configuration.
