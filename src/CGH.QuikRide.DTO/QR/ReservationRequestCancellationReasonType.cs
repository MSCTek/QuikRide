...
namespace CGH.QuikRide.DTO.QR
{
	public partial class ReservationRequestCancellationReasonType
	{
		...
		public int ReservationRequestCancellationReasonTypeId { get; set; } // Primary key
		...
		public virtual System.Collections.Generic.ICollection<ReservationRequestCancellationReasonTypeTranslation> ReservationRequestCancellationReasonTypeTranslations { get; set; } // Many to many mapping
