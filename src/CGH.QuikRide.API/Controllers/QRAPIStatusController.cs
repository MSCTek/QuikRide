...
{
	public partial class QRAPIStatusController : QRBaseApiController
	{
		public QRAPIStatusController() : base()
		{
		}
		...
		[HttpGet]
		[VersionedRoute(template: "APIStatus", allowedVersion: 1, Name = "QRAPIStatus")]
