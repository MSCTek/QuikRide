...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class FeedbacksQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Feedback newDBItem, ref IRepositoryActionResult<entQR.Feedback> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Feedback updatedDBItem, ref IRepositoryActionResult<entQR.Feedback> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Feedback updatedDBItem, ref IRepositoryActionResult<entQR.Feedback> result) {}
