...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestStatusTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequestStatusTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequestStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequestStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusTypeTranslation> result) {}
