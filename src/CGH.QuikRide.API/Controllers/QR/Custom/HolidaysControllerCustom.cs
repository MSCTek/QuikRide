...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class HolidaysQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Holiday newDBItem, ref IRepositoryActionResult<entQR.Holiday> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Holiday updatedDBItem, ref IRepositoryActionResult<entQR.Holiday> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Holiday updatedDBItem, ref IRepositoryActionResult<entQR.Holiday> result) {}
