...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationStatusTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationStatusType newDBItem, ref IRepositoryActionResult<entQR.ReservationStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationStatusType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationStatusType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationStatusType> result) {}
