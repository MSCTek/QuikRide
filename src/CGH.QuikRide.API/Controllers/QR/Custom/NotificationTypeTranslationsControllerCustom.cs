...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class NotificationTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.NotificationTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.NotificationTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.NotificationTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.NotificationTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.NotificationTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.NotificationTypeTranslation> result) {}
