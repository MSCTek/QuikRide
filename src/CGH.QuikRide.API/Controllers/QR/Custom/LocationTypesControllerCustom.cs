...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class LocationTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.LocationType newDBItem, ref IRepositoryActionResult<entQR.LocationType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.LocationType updatedDBItem, ref IRepositoryActionResult<entQR.LocationType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.LocationType updatedDBItem, ref IRepositoryActionResult<entQR.LocationType> result) {}
