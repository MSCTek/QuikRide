...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UsersNotificationTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.UsersNotificationType newDBItem, ref IRepositoryActionResult<entQR.UsersNotificationType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.UsersNotificationType updatedDBItem, ref IRepositoryActionResult<entQR.UsersNotificationType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.UsersNotificationType updatedDBItem, ref IRepositoryActionResult<entQR.UsersNotificationType> result) {}
