...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleType newDBItem, ref IRepositoryActionResult<entQR.VehicleType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleType> result) {}
