...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleStatusTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleStatusTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result) {}
