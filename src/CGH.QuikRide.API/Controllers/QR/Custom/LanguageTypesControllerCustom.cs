...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class LanguageTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.LanguageType newDBItem, ref IRepositoryActionResult<entQR.LanguageType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.LanguageType updatedDBItem, ref IRepositoryActionResult<entQR.LanguageType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.LanguageType updatedDBItem, ref IRepositoryActionResult<entQR.LanguageType> result) {}
