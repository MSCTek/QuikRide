...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class RideServiceTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.RideServiceType newDBItem, ref IRepositoryActionResult<entQR.RideServiceType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.RideServiceType updatedDBItem, ref IRepositoryActionResult<entQR.RideServiceType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.RideServiceType updatedDBItem, ref IRepositoryActionResult<entQR.RideServiceType> result) {}
