...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class LocationTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.LocationTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.LocationTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.LocationTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.LocationTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.LocationTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.LocationTypeTranslation> result) {}
