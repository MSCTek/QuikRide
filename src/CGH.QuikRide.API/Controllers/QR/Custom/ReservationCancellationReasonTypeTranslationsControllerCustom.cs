...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationCancellationReasonTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationCancellationReasonTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationCancellationReasonTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationCancellationReasonTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonTypeTranslation> result) {}
