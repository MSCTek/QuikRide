...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleVehicleFeatureTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleVehicleFeatureType newDBItem, ref IRepositoryActionResult<entQR.VehicleVehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleVehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleVehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleVehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleVehicleFeatureType> result) {}
