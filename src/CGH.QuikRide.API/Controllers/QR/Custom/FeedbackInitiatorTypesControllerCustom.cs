...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class FeedbackInitiatorTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.FeedbackInitiatorType newDBItem, ref IRepositoryActionResult<entQR.FeedbackInitiatorType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.FeedbackInitiatorType updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackInitiatorType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.FeedbackInitiatorType updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackInitiatorType> result) {}
