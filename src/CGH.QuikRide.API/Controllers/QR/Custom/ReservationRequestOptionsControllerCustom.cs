...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestOptionsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequestOption newDBItem, ref IRepositoryActionResult<entQR.ReservationRequestOption> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequestOption updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestOption> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequestOption updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestOption> result) {}
