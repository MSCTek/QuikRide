...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BusRouteTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BusRouteTranslation newDBItem, ref IRepositoryActionResult<entQR.BusRouteTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BusRouteTranslation updatedDBItem, ref IRepositoryActionResult<entQR.BusRouteTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BusRouteTranslation updatedDBItem, ref IRepositoryActionResult<entQR.BusRouteTranslation> result) {}
