...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationStatusTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationStatusTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.ReservationStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationStatusTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationStatusTypeTranslation> result) {}
