...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BusRoutesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BusRoute newDBItem, ref IRepositoryActionResult<entQR.BusRoute> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BusRoute updatedDBItem, ref IRepositoryActionResult<entQR.BusRoute> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BusRoute updatedDBItem, ref IRepositoryActionResult<entQR.BusRoute> result) {}
