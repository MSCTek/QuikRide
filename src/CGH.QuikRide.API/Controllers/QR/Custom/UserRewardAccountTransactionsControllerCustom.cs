...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UserRewardAccountTransactionsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.UserRewardAccountTransaction newDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransaction> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.UserRewardAccountTransaction updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransaction> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.UserRewardAccountTransaction updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransaction> result) {}
