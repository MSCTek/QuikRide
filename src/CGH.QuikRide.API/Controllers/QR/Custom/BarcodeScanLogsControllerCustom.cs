...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BarcodeScanLogsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BarcodeScanLog newDBItem, ref IRepositoryActionResult<entQR.BarcodeScanLog> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BarcodeScanLog updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeScanLog> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BarcodeScanLog updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeScanLog> result) {}
