...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BarcodeTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BarcodeType newDBItem, ref IRepositoryActionResult<entQR.BarcodeType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BarcodeType updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BarcodeType updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeType> result) {}
