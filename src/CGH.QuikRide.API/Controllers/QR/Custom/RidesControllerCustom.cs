...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class RidesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Ride newDBItem, ref IRepositoryActionResult<entQR.Ride> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Ride updatedDBItem, ref IRepositoryActionResult<entQR.Ride> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Ride updatedDBItem, ref IRepositoryActionResult<entQR.Ride> result) {}
