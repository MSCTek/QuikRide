...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleFeatureTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleFeatureType newDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureType> result) {}
