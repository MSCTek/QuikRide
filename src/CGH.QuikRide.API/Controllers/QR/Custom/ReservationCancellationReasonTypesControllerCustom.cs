...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationCancellationReasonTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationCancellationReasonType newDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationCancellationReasonType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationCancellationReasonType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationCancellationReasonType> result) {}
