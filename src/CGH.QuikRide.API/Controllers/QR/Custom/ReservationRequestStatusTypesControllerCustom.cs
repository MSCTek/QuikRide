...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestStatusTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequestStatusType newDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequestStatusType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequestStatusType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestStatusType> result) {}
