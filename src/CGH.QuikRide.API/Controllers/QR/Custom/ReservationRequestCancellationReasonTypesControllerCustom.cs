...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestCancellationReasonTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequestCancellationReasonType newDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequestCancellationReasonType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequestCancellationReasonType updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonType> result) {}
