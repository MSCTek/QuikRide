...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleBusRoutesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleBusRoute newDBItem, ref IRepositoryActionResult<entQR.VehicleBusRoute> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleBusRoute updatedDBItem, ref IRepositoryActionResult<entQR.VehicleBusRoute> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleBusRoute updatedDBItem, ref IRepositoryActionResult<entQR.VehicleBusRoute> result) {}
