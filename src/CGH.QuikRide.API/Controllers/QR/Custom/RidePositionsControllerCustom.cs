...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class RidePositionsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.RidePosition newDBItem, ref IRepositoryActionResult<entQR.RidePosition> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.RidePosition updatedDBItem, ref IRepositoryActionResult<entQR.RidePosition> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.RidePosition updatedDBItem, ref IRepositoryActionResult<entQR.RidePosition> result) {}
