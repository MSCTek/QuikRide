...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UserRewardAccountTransactionTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.UserRewardAccountTransactionType newDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.UserRewardAccountTransactionType updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.UserRewardAccountTransactionType updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionType> result) {}
