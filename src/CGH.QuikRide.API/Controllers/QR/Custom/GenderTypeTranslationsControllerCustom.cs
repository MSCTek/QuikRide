...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class GenderTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.GenderTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.GenderTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.GenderTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.GenderTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.GenderTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.GenderTypeTranslation> result) {}
