...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class FeedbackTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.FeedbackType newDBItem, ref IRepositoryActionResult<entQR.FeedbackType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.FeedbackType updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.FeedbackType updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackType> result) {}
