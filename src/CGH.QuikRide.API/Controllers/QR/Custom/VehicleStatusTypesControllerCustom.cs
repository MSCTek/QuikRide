...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleStatusTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleStatusType newDBItem, ref IRepositoryActionResult<entQR.VehicleStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleStatusType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleStatusType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusType> result) {}
