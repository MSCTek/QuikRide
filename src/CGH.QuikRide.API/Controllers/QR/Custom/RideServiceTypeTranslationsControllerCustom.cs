...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class RideServiceTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.RideServiceTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.RideServiceTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.RideServiceTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.RideServiceTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.RideServiceTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.RideServiceTypeTranslation> result) {}
