...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BusRouteStopsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BusRouteStop newDBItem, ref IRepositoryActionResult<entQR.BusRouteStop> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BusRouteStop updatedDBItem, ref IRepositoryActionResult<entQR.BusRouteStop> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BusRouteStop updatedDBItem, ref IRepositoryActionResult<entQR.BusRouteStop> result) {}
