...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class GenderTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.GenderType newDBItem, ref IRepositoryActionResult<entQR.GenderType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.GenderType updatedDBItem, ref IRepositoryActionResult<entQR.GenderType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.GenderType updatedDBItem, ref IRepositoryActionResult<entQR.GenderType> result) {}
