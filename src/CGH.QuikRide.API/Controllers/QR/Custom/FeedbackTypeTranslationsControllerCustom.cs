...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class FeedbackTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.FeedbackTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.FeedbackTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.FeedbackTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result) {}
