...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UsersQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.User newDBItem, ref IRepositoryActionResult<entQR.User> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.User updatedDBItem, ref IRepositoryActionResult<entQR.User> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.User updatedDBItem, ref IRepositoryActionResult<entQR.User> result) {}
