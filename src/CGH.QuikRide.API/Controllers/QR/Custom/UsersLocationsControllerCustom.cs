...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UsersLocationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.UsersLocation newDBItem, ref IRepositoryActionResult<entQR.UsersLocation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.UsersLocation updatedDBItem, ref IRepositoryActionResult<entQR.UsersLocation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.UsersLocation updatedDBItem, ref IRepositoryActionResult<entQR.UsersLocation> result) {}
