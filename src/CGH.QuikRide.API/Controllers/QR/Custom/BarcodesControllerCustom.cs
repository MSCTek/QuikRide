...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BarcodesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Barcode newDBItem, ref IRepositoryActionResult<entQR.Barcode> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Barcode updatedDBItem, ref IRepositoryActionResult<entQR.Barcode> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Barcode updatedDBItem, ref IRepositoryActionResult<entQR.Barcode> result) {}
