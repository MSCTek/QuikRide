...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class DriverShiftsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.DriverShift newDBItem, ref IRepositoryActionResult<entQR.DriverShift> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.DriverShift updatedDBItem, ref IRepositoryActionResult<entQR.DriverShift> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.DriverShift updatedDBItem, ref IRepositoryActionResult<entQR.DriverShift> result) {}
