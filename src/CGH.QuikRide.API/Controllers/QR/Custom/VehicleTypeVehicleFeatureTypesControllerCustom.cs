...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleTypeVehicleFeatureTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleTypeVehicleFeatureType newDBItem, ref IRepositoryActionResult<entQR.VehicleTypeVehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleTypeVehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleTypeVehicleFeatureType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleTypeVehicleFeatureType updatedDBItem, ref IRepositoryActionResult<entQR.VehicleTypeVehicleFeatureType> result) {}
