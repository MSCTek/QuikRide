...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class HolidayTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.HolidayTranslation newDBItem, ref IRepositoryActionResult<entQR.HolidayTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.HolidayTranslation updatedDBItem, ref IRepositoryActionResult<entQR.HolidayTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.HolidayTranslation updatedDBItem, ref IRepositoryActionResult<entQR.HolidayTranslation> result) {}
