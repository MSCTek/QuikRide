...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequest newDBItem, ref IRepositoryActionResult<entQR.ReservationRequest> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequest updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequest> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequest updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequest> result) {}
