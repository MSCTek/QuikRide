...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Reservation newDBItem, ref IRepositoryActionResult<entQR.Reservation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Reservation updatedDBItem, ref IRepositoryActionResult<entQR.Reservation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Reservation updatedDBItem, ref IRepositoryActionResult<entQR.Reservation> result) {}
