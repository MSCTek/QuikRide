...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class ReservationRequestCancellationReasonTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.ReservationRequestCancellationReasonTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.ReservationRequestCancellationReasonTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.ReservationRequestCancellationReasonTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.ReservationRequestCancellationReasonTypeTranslation> result) {}
