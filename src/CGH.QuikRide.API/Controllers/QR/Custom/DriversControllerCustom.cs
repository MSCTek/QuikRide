...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class DriversQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Driver newDBItem, ref IRepositoryActionResult<entQR.Driver> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Driver updatedDBItem, ref IRepositoryActionResult<entQR.Driver> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Driver updatedDBItem, ref IRepositoryActionResult<entQR.Driver> result) {}
