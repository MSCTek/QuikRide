...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class LocationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Location newDBItem, ref IRepositoryActionResult<entQR.Location> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Location updatedDBItem, ref IRepositoryActionResult<entQR.Location> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Location updatedDBItem, ref IRepositoryActionResult<entQR.Location> result) {}
