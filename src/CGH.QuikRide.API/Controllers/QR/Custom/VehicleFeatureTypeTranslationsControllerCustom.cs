...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehicleFeatureTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.VehicleFeatureTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.VehicleFeatureTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.VehicleFeatureTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleFeatureTypeTranslation> result) {}
