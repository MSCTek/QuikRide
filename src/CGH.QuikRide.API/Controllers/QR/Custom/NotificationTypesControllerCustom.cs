...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class NotificationTypesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.NotificationType newDBItem, ref IRepositoryActionResult<entQR.NotificationType> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.NotificationType updatedDBItem, ref IRepositoryActionResult<entQR.NotificationType> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.NotificationType updatedDBItem, ref IRepositoryActionResult<entQR.NotificationType> result) {}
