...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class UserRewardAccountTransactionTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.UserRewardAccountTransactionTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.UserRewardAccountTransactionTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.UserRewardAccountTransactionTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result) {}
