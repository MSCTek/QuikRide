...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class BarcodeTypeTranslationsQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.BarcodeTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.BarcodeTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.BarcodeTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeTypeTranslation> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.BarcodeTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.BarcodeTypeTranslation> result) {}
