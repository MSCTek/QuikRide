...
namespace CGH.QuikRide.API.Controllers.QR
{
	public partial class VehiclesQRController : QRBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entQR.Vehicle newDBItem, ref IRepositoryActionResult<entQR.Vehicle> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entQR.Vehicle updatedDBItem, ref IRepositoryActionResult<entQR.Vehicle> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entQR.Vehicle updatedDBItem, ref IRepositoryActionResult<entQR.Vehicle> result) {}
