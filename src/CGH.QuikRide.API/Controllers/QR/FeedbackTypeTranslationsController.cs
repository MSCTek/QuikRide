...
{
	public partial class FeedbackTypeTranslationsQRController : QRBaseApiController
	{
			private const string GET_LIST_ROUTE_NAME = "FeedbackTypeTranslationsQRList";
			private const int maxPageSize = 100;

			private GenericFactory<entQR.FeedbackTypeTranslation, dtoQR.FeedbackTypeTranslation> _factory 
				= new GenericFactory<entQR.FeedbackTypeTranslation, dtoQR.FeedbackTypeTranslation>();

		public FeedbackTypeTranslationsQRController() : base()
		{
		}

		public FeedbackTypeTranslationsQRController(ILoggingService log, IQRRepository repository)
		: base(log, repository)
		{
		}

		[HttpDelete]
		[VersionedRoute(template: "FeedbackTypeTranslations/{feedbackTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Delete(int feedbackTypeTranslationId)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }

				var result = await Repo.Delete_FeedbackTypeTranslationAsync(feedbackTypeTranslationId);
		...
		[HttpGet]
		[VersionedRoute(template: "FeedbackTypeTranslations", allowedVersion: 1, Name = GET_LIST_ROUTE_NAME)]
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_FeedbackTypeTranslation().AsNoTracking();
				RunCustomLogicAfterGetQueryableList(ref dbItems, ref filterList);
				dbItems = dbItems.ApplyFilter(filterList);
				dbItems = dbItems.ApplySort(sort ?? (typeof(entQR.FeedbackTypeTranslation).GetProperties(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)).First().Name);
		...
		[HttpGet]
		[VersionedRoute(template: "FeedbackTypeTranslations/{feedbackTypeTranslationId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int feedbackTypeTranslationId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_FeedbackTypeTranslationAsync(feedbackTypeTranslationId, numChildLevels);
				...
				RunCustomLogicOnGetEntityByPK(ref dbItem, feedbackTypeTranslationId, numChildLevels);
		...
		[HttpPatch]
		[VersionedRoute(template: "FeedbackTypeTranslations/{feedbackTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Patch(int feedbackTypeTranslationId, [FromBody] JsonPatchDocument<dtoQR.FeedbackTypeTranslation> patchDocument)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				var dbItem = await Repo.Get_FeedbackTypeTranslationAsync(feedbackTypeTranslationId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
				...
				dtoItem.FeedbackTypeTranslationId = feedbackTypeTranslationId;
		...
		[HttpPost]
		[VersionedRoute(template: "FeedbackTypeTranslations", allowedVersion: 1)]
		public async Task<IHttpActionResult> Post([FromBody] dtoQR.FeedbackTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				{   // map to dto
					...
					return Created($"{uriFormatted}/{newDTOItem.FeedbackTypeTranslationId}", newDTOItem);
				}
		...
		[HttpPut]
		[VersionedRoute(template: "FeedbackTypeTranslations/{feedbackTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Put(int feedbackTypeTranslationId, [FromBody] dtoQR.FeedbackTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
		...
		partial void RunCustomLogicAfterInsert(ref CGH.QuikRide.Repository.Entities.QR.FeedbackTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CGH.QuikRide.Repository.Entities.QR.FeedbackTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePut(ref CGH.QuikRide.Repository.Entities.QR.FeedbackTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.FeedbackTypeTranslation> result);

		partial void RunCustomLogicOnGetEntityByPK(ref entQR.FeedbackTypeTranslation dbItem, int feedbackTypeTranslationId, int numChildLevels);

		partial void RunCustomLogicAfterGetQueryableList(ref IQueryable<entQR.FeedbackTypeTranslation> dbItems, ref List<string> filterList);
	}
}