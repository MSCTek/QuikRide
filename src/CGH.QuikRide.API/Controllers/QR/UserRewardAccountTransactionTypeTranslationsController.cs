...
{
	public partial class UserRewardAccountTransactionTypeTranslationsQRController : QRBaseApiController
	{
			private const string GET_LIST_ROUTE_NAME = "UserRewardAccountTransactionTypeTranslationsQRList";
			private const int maxPageSize = 100;

			private GenericFactory<entQR.UserRewardAccountTransactionTypeTranslation, dtoQR.UserRewardAccountTransactionTypeTranslation> _factory 
				= new GenericFactory<entQR.UserRewardAccountTransactionTypeTranslation, dtoQR.UserRewardAccountTransactionTypeTranslation>();

		public UserRewardAccountTransactionTypeTranslationsQRController() : base()
		{
		}
		...
		[HttpDelete]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations/{userRewardAccountTransactionTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Delete(int userRewardAccountTransactionTypeTranslationId)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }

				var result = await Repo.Delete_UserRewardAccountTransactionTypeTranslationAsync(userRewardAccountTransactionTypeTranslationId);
		...
		[HttpGet]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations", allowedVersion: 1, Name = GET_LIST_ROUTE_NAME)]
		...
		[HttpGet]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations/{userRewardAccountTransactionTypeTranslationId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int userRewardAccountTransactionTypeTranslationId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_UserRewardAccountTransactionTypeTranslationAsync(userRewardAccountTransactionTypeTranslationId, numChildLevels);
				...
				RunCustomLogicOnGetEntityByPK(ref dbItem, userRewardAccountTransactionTypeTranslationId, numChildLevels);
		...
		[HttpPatch]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations/{userRewardAccountTransactionTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Patch(int userRewardAccountTransactionTypeTranslationId, [FromBody] JsonPatchDocument<dtoQR.UserRewardAccountTransactionTypeTranslation> patchDocument)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				var dbItem = await Repo.Get_UserRewardAccountTransactionTypeTranslationAsync(userRewardAccountTransactionTypeTranslationId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
				...
				dtoItem.UserRewardAccountTransactionTypeTranslationId = userRewardAccountTransactionTypeTranslationId;
		...
		[HttpPost]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations", allowedVersion: 1)]
		public async Task<IHttpActionResult> Post([FromBody] dtoQR.UserRewardAccountTransactionTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				{   // map to dto
					...
					return Created($"{uriFormatted}/{newDTOItem.UserRewardAccountTransactionTypeTranslationId}", newDTOItem);
				}
		...
		[HttpPut]
		[VersionedRoute(template: "UserRewardAccountTransactionTypeTranslations/{userRewardAccountTransactionTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Put(int userRewardAccountTransactionTypeTranslationId, [FromBody] dtoQR.UserRewardAccountTransactionTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
		...
		partial void RunCustomLogicAfterInsert(ref CGH.QuikRide.Repository.Entities.QR.UserRewardAccountTransactionTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CGH.QuikRide.Repository.Entities.QR.UserRewardAccountTransactionTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePut(ref CGH.QuikRide.Repository.Entities.QR.UserRewardAccountTransactionTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.UserRewardAccountTransactionTypeTranslation> result);

		partial void RunCustomLogicOnGetEntityByPK(ref entQR.UserRewardAccountTransactionTypeTranslation dbItem, int userRewardAccountTransactionTypeTranslationId, int numChildLevels);

		partial void RunCustomLogicAfterGetQueryableList(ref IQueryable<entQR.UserRewardAccountTransactionTypeTranslation> dbItems, ref List<string> filterList);
	}
}