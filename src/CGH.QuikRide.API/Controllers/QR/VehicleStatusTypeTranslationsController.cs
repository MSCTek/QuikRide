...
{
	public partial class VehicleStatusTypeTranslationsQRController : QRBaseApiController
	{
			private const string GET_LIST_ROUTE_NAME = "VehicleStatusTypeTranslationsQRList";
			private const int maxPageSize = 100;

			private GenericFactory<entQR.VehicleStatusTypeTranslation, dtoQR.VehicleStatusTypeTranslation> _factory 
				= new GenericFactory<entQR.VehicleStatusTypeTranslation, dtoQR.VehicleStatusTypeTranslation>();

		public VehicleStatusTypeTranslationsQRController() : base()
		{
		}
		...
		[HttpDelete]
		[VersionedRoute(template: "VehicleStatusTypeTranslations/{vehicleStatusTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Delete(int vehicleStatusTypeTranslationId)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }

				var result = await Repo.Delete_VehicleStatusTypeTranslationAsync(vehicleStatusTypeTranslationId);
		...
		[HttpGet]
		[VersionedRoute(template: "VehicleStatusTypeTranslations", allowedVersion: 1, Name = GET_LIST_ROUTE_NAME)]
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_VehicleStatusTypeTranslation().AsNoTracking();
				RunCustomLogicAfterGetQueryableList(ref dbItems, ref filterList);
				dbItems = dbItems.ApplyFilter(filterList);
				dbItems = dbItems.ApplySort(sort ?? (typeof(entQR.VehicleStatusTypeTranslation).GetProperties(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)).First().Name);
		...
		[HttpGet]
		[VersionedRoute(template: "VehicleStatusTypeTranslations/{vehicleStatusTypeTranslationId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int vehicleStatusTypeTranslationId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_VehicleStatusTypeTranslationAsync(vehicleStatusTypeTranslationId, numChildLevels);
				...
				RunCustomLogicOnGetEntityByPK(ref dbItem, vehicleStatusTypeTranslationId, numChildLevels);
		...
		[HttpPatch]
		[VersionedRoute(template: "VehicleStatusTypeTranslations/{vehicleStatusTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Patch(int vehicleStatusTypeTranslationId, [FromBody] JsonPatchDocument<dtoQR.VehicleStatusTypeTranslation> patchDocument)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				var dbItem = await Repo.Get_VehicleStatusTypeTranslationAsync(vehicleStatusTypeTranslationId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
				...
				dtoItem.VehicleStatusTypeTranslationId = vehicleStatusTypeTranslationId;
		...
		[HttpPost]
		[VersionedRoute(template: "VehicleStatusTypeTranslations", allowedVersion: 1)]
		public async Task<IHttpActionResult> Post([FromBody] dtoQR.VehicleStatusTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				...
				{   // map to dto
					...
					return Created($"{uriFormatted}/{newDTOItem.VehicleStatusTypeTranslationId}", newDTOItem);
				}
		...
		[HttpPut]
		[VersionedRoute(template: "VehicleStatusTypeTranslations/{vehicleStatusTypeTranslationId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Put(int vehicleStatusTypeTranslationId, [FromBody] dtoQR.VehicleStatusTypeTranslation dtoItem)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
		...
		partial void RunCustomLogicAfterInsert(ref CGH.QuikRide.Repository.Entities.QR.VehicleStatusTypeTranslation newDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CGH.QuikRide.Repository.Entities.QR.VehicleStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result);

		partial void RunCustomLogicAfterUpdatePut(ref CGH.QuikRide.Repository.Entities.QR.VehicleStatusTypeTranslation updatedDBItem, ref IRepositoryActionResult<entQR.VehicleStatusTypeTranslation> result);

		partial void RunCustomLogicOnGetEntityByPK(ref entQR.VehicleStatusTypeTranslation dbItem, int vehicleStatusTypeTranslationId, int numChildLevels);

		partial void RunCustomLogicAfterGetQueryableList(ref IQueryable<entQR.VehicleStatusTypeTranslation> dbItems, ref List<string> filterList);
	}
}