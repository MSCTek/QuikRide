...
namespace CGH.QuikRide.API.Controllers.QR
{
	...
	[RoutePrefix("api/QR")]
	public abstract partial class QRBaseApiController : ApiController, ILoggingService
	{
		private ILoggingService _log;
		private IQRRepository _repository;
		...
		protected IQRRepository Repo { get { return _repository; } }
