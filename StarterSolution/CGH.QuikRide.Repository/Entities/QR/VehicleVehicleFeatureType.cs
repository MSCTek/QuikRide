...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    public partial class VehicleVehicleFeatureType
    {
        ...
        /// <summary>
        /// Parent Vehicle pointed by [Vehicle_VehicleFeatureType].([VehicleId]) (FK_Vehicle_VehicleFeatureType_Vehicle)
        /// </summary>
        public Vehicle Vehicle { get; set; } // FK_Vehicle_VehicleFeatureType_Vehicle

        /// <summary>
        /// Parent VehicleFeatureType pointed by [Vehicle_VehicleFeatureType].([VehicleFeatureTypeId]) (FK_Vehicle_VehicleFeatureType_VehicleFeatureType)
        /// </summary>
        public VehicleFeatureType VehicleFeatureType { get; set; } // FK_Vehicle_VehicleFeatureType_VehicleFeatureType
