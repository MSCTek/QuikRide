...
namespace CGH.QuikRide.Repository.Entities.QR
{
    ...
    public partial class FeedbackTypeTranslationConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FeedbackTypeTranslation>
    {
        public FeedbackTypeTranslationConfiguration()
            : this("dbo")
        {
        }

        public FeedbackTypeTranslationConfiguration(string schema)
        {
            ToTable("FeedbackTypeTranslation", schema);
            HasKey(x => x.FeedbackTypeTranslationId);

            Property(x => x.FeedbackTypeTranslationId).HasColumnName(@"FeedbackTypeTranslationId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            ...
            // Foreign keys
            HasRequired(a => a.FeedbackType).WithMany(b => b.FeedbackTypeTranslations).HasForeignKey(c => c.FeedbackTypeId); // FK_FeedbackTypeTranslation_FeedbackType
            HasRequired(a => a.LanguageType).WithMany(b => b.FeedbackTypeTranslations).HasForeignKey(c => c.LanguageTypeId).WillCascadeOnDelete(false); // FK_FeedbackTypeTranslation_LanguageType
            InitializePartial();
        }
