...
{
	public partial class LocationType : ObservableObject
	{
		public LocationType()
		{
			Locations = new System.Collections.Generic.List<Location>(); // Reverse Navigation
		...
		public virtual System.Collections.Generic.IList<Location> Locations { get; set; } // Many to many mapping
