...
{
	public partial class LocationTypeTranslation : ObservableObject
	{
		...
		private int _locationTypeTranslationId;
		...
		public int LocationTypeTranslationId
		{
			get { return _locationTypeTranslationId; }
			set
			{
				Set<int>(() => LocationTypeTranslationId, ref _locationTypeTranslationId, value);
				RunCustomLogicSetLocationTypeTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetLocationTypeTranslationId(int value);
