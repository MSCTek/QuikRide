...
{
	public partial class GenderTypeTranslation : ObservableObject
	{
		...
		private int _genderTypeTranslationId;
		...
		public int GenderTypeTranslationId
		{
			get { return _genderTypeTranslationId; }
			set
			{
				Set<int>(() => GenderTypeTranslationId, ref _genderTypeTranslationId, value);
				RunCustomLogicSetGenderTypeTranslationId(value);
			}
		}
		...
		partial void RunCustomLogicSetGenderTypeTranslationId(int value);
